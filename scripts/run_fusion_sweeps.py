...
RRF_K_VALUES = [1, 10, 20, 60, 100, 200, 1000]
WEIGHT_VALUES = [0.1, 0.25, 0.5, 1.0, 2.0, 4.0, 10.0]
...
def score_fusion(
    ...
    row: dict[str, Any] = {
        ...
        "run_name": f"{dataset}_{sweep_name}_{dense_row['run_name']}_rrf{rrf_k}_bw{bm25_weight}_dw{dense_weight}_bd{bm25_depth}_dd{dense_depth}",
        "dataset": dataset,
