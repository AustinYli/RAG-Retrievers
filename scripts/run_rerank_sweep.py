...
def main() -> None:
    ...
    model.max_length = args.max_seq_length
    model_load_seconds = time.perf_counter() - model_started

    for dataset, base_rows in best_bases_by_dataset(rows, limit=2).items():
        ...
        for base_row in base_rows:
            ...
            for rerank_top_k in RERANK_TOP_K_VALUES:
                ...
                row: dict[str, Any] = {
                    ...
                    "run_name": f"{dataset}_rerank_sweep_{base_row['run_name']}_top{rerank_top_k}",
                    "dataset": dataset,
                ...
                append_result(Path(args.output), row)
